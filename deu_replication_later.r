...
#generate cogs share of rev
#alpha = cogs /  sales
data$alpha <- data$cogs / data$sale
...
source("function_deu.R")
theta_st <-
  acf_rolling_window_exp(pdata, yvar, xvars, zvars, zvars, orthogx, r, block)
view(theta_st)
...
write.csv(data_st, "DEU_s_yr.csv")
write.csv(data_s, "DEU_s.csv")
